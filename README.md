...
*   **Native & Browser File System Access:** Open single files or entire workspaces. CaramelPepper reads and writes directly to your hard drive using a Node.js backend when running locally, or utilizes the Browser FS API in hosted mode.
...
*   **State Management:** Context + Hooks (Custom Global Store)
...
2.  **Pull a coding model:**
    ...
    ```
3.  In the CaramelPepper UI, navigate to the **Settings**.
...
CaramelPepper supports two distinct ways to interact with your code:
