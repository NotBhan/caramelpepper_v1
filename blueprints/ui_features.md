...
> 🌶️ **Pro-Tip:** Your layout preferences (panel sizes) are persisted to `localStorage`, so your workspace feels exactly how you left it every time you return.
...
*   **Active Highlighting:** Clear visual feedback with the **Caramel Amber** highlight for the currently open file.
...
*   **Risk Indicators:** Color-coded badges and progress bars:
    *   🟢 **Low Risk:** Clean, maintainable code.
    *   🟡 **Moderate Risk:** Starting to show technical debt.
    *   🔴 **High/Critical Risk:** Priority candidates for refactoring.
...
Before generating a single line of code, CaramelPepper's AI pre-processor scans your existing files to detect:
...
### Hybrid Inference Engine 🌶️🍬
CaramelPepper is "Privacy by Default, Cloud Optional". Through the **Settings Vault**, you can swap between:
...
Ready to spice up your code? Happy Refactoring! 🌶️🍬
